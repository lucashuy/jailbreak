...
function PLAYER:GetHandsModel()
	...
	for k, v in pairs( player_manager.AllValidModels() ) do
		if ( string.lower(v) == string.lower( self.Player:GetModel() ) ) then
			return player_manager.TranslatePlayerHands(k);
		end;
	end;
...
player_manager.RegisterClass( "player_jb", PLAYER, nil )
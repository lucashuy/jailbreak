...
function SWEP:CalcView(ply, pos, ang, fov)
	...
	if self.CameraAngCache then
		...
		if stat == TFA.Enum.STATUS_RELOADING_SHOTGUN_END or stat == TFA.Enum.STATUS_RELOADING or ( stat == TFA.Enum.STATUS_RELOADING_WAIT and not self.Shotgun ) or stat == TFA.Enum.STATUS_SHOOTING then

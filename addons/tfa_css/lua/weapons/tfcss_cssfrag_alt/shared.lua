...
SWEP.Gun = ("tfcss_cssfrag_alt") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Alt Frag Grenade"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Round 			= ("tfcss_throwncssfrag")	--NAME OF ENTITY GOES HERE

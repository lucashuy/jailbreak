...
SWEP.Gun = ("tfcss_css_c4_alt") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Alt C4"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Round 			= ("tfcss_planted_alt_c4")	--NAME OF ENTITY GOES HERE
...
function SWEP:PrimaryAttack()
	...
	if SERVER and self.Weapon != nil then if self.Weapon:GetOwner():GetActiveWeapon():GetClass() == self.Gun then
		if self:CanPrimaryAttack() then
			...
			local boxes
			parentme = {}
			parentme[1] = "tfa_ammo_40mm"
			parentme[2] = "tfa_ammo_c4"
			parentme[3] = "tfa_ammo_frags"
			parentme[4] = "tfa_ammo_ieds"
			parentme[5] = "tfa_ammo_nervegas"
			parentme[6] = "tfa_ammo_nuke"
			parentme[7] = "tfa_ammo_proxmines"
			parentme[8] = "tfa_ammo_rockets"
			parentme[9] = "tfa_ammo_stickynades"
			parentme[10] = "tfa_ammo_357"
			parentme[11] = "tfa_ammo_ar2"
			parentme[12] = "tfa_ammo_buckshot"
			parentme[13] = "tfa_ammo_pistol"
			parentme[14] = "tfa_ammo_smg"
			parentme[15] = "tfa_ammo_sniper_rounds"
			parentme[16] = "tfa_ammo_winchester"

...
SWEP.Gun = ("tfcss_css_c4") -- must be the name of your swep but NO CAPITALS!
...
SWEP.Primary.Round 			= ("tfcss_planted_css_c4")	--NAME OF ENTITY GOES HERE
	...
	if SERVER and self.Weapon != nil then if self.Weapon:GetOwner():GetActiveWeapon():GetClass() == self.Gun then
		if self:CanPrimaryAttack() then
			...
			if !(IsMounted("cstrike")) then
				self.Primary.Round = "tfcss_planted_alt_c4"
			end	
